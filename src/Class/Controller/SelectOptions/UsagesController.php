...
{
    private const string ROUTE = '/class/select-option/{id}/usages';
    ...
    #[Route(
        path: self::ROUTE,
        name: 'pimcore_studio_api_class_select_option_get_usages',
        methods: ['GET']
    )]
    ...
    #[Get(
        ...
        description: 'class_select_option_get_usages_description',
        summary: 'class_select_option_get_usages_summary',
    ...
    #[SuccessResponse(
        description: 'class_select_option_get_usages_success_response',
        content: new ItemsJson(SelectOptionUsageItem::class)
    )]
    #[DefaultResponses([
        HttpResponseCodes::NOT_FOUND,
        HttpResponseCodes::UNAUTHORIZED,
    ])]
    public function getSelectOptionUsages(string $id): JsonResponse
    {
        return $this->jsonResponse(
            ['items' => $this->selectOptionService->getSelectOptionUsages($id)]
        );
    }
}
