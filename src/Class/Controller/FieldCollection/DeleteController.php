...
final class DeleteController extends AbstractApiController
{
    ...
    #[Route(
        self::ROUTE,
        name: 'pimcore_studio_api_class_field_collection_delete',
        methods: ['DELETE']
    )]
    ...
    #[Delete(
        ...
        description: 'class_field_collection_delete_description',
        summary: 'class_field_collection_delete_summary',
    ...
    #[SuccessResponse(
        description: 'class_field_collection_delete_success_response'
    )]
    #[DefaultResponses([
    ...
    public function deleteFieldCollection(string $key): Response
    {
        $this->fieldCollectionService->deleteFieldCollection($key);
