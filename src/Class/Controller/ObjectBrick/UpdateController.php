...
use Pimcore\Bundle\StudioBackendBundle\Class\Attribute\Request\ObjectBrickUpdateRequestBody;
...
final class UpdateController extends AbstractApiController
{
    ...
    #[Route(
        self::ROUTE,
        name: 'pimcore_studio_api_class_object_brick_update',
        methods: ['PUT']
    )]
    ...
    #[Put(
        ...
        description: 'class_object_brick_update_description',
        summary: 'class_object_brick_update_summary',
    ...
    #[ObjectBrickUpdateRequestBody]
    #[SuccessResponse(
        description: 'class_object_brick_update_success_response',
    ...
    public function updateObjectBrick(
        string $key,
        #[MapRequestPayload] UpdateParameters $parameters,
    ): JsonResponse {
        return $this->jsonResponse(
            $this->objectBrickService->updateObjectBrick($key, $parameters)
        );
    }
}
