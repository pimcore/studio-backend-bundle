...
use Pimcore\Bundle\StudioBackendBundle\Search\Schema\Configuration as ConfigurationSchema;
...
{
    public function hydrate(SavedSearchConfiguration $data): ConfigurationSchema;
}
