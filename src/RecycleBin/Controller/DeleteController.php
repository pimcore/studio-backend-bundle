...
final class DeleteController extends AbstractApiController
{
    ...
    private const string ROUTE = '/recycle-bin/delete';
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_recycle_bin_delete', methods: ['DELETE'])]
    #[IsGranted(UserPermissions::RECYCLE_BIN->value)]
    #[Delete(
        path: self::PREFIX . self::ROUTE,
        operationId: 'recycle_bin_delete_items',
        description: 'recycle_bin_delete_items_description',
        summary: 'recycle_bin_delete_items_summary',
        tags: [Tags::RecycleBin->value]
    )]
    #[RequestBody(
        content: new ScalarItemsJson('integer', 'items'),
    )]
    #[SuccessResponse(description: 'recycle_bin_delete_items_success_response')]
    #[CreatedResponse(
        description: 'recycle_bin_delete_items_created_response',
    ...
    public function deleteRecycleBinItems(
        #[MapRequestPayload] ItemsParameter $parameters
    ): Response {
        $jobRunId = $this->recycleBinService->delete($parameters);
