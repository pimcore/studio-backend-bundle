 ...
 * @internal
 */
final readonly class CollectionHydrator implements CollectionHydratorInterface
{
    public function hydrateCollectionDetail(CollectionConfig $collectionConfig): CollectionDetail
    {
        return new CollectionDetail(
            ...
            $collectionConfig->getStoreId(),
            $collectionConfig->getDescription(),
            $collectionConfig->getCreationDate(),
