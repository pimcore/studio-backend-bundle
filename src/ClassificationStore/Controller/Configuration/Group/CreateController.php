...
{
    private const string ROUTE = '/classification-store/configuration/groups/add';
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_cs_configuration_group_create', methods: ['POST'], priority: 10)]
    #[IsGranted(UserPermissions::CLASSIFICATION_STORE->value)]
    #[Post(
        path: self::PREFIX . self::ROUTE,
        operationId: 'classification_store_configuration_group_create',
        description: 'classification_store_configuration_group_create_description',
        summary: 'classification_store_configuration_group_create_summary',
        tags: [Tags::ClassificationStore->value]
    )]
    #[ReferenceRequestBody(GroupCreate::class)]
    #[SuccessResponse(
        description: 'classification_store_configuration_group_create_success_response',
        content: new JsonContent(ref: GroupDetail::class)
    )]
    #[DefaultResponses([
    ...
    public function createGroup(
        #[MapRequestPayload] GroupCreate $parameters
    ): JsonResponse {
        return $this->jsonResponse($this->groupService->createGroup($parameters));
    }
}
