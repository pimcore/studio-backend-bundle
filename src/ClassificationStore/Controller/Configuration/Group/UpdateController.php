...
final class UpdateController extends AbstractApiController
{
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_cs_configuration_group_update', methods: ['PUT'])]
    #[IsGranted(UserPermissions::CLASSIFICATION_STORE->value)]
    #[Put(
        path: self::PREFIX . self::ROUTE,
        operationId: 'classification_store_configuration_group_update',
        description: 'classification_store_configuration_group_update_description',
        summary: 'classification_store_configuration_group_update_summary',
        tags: [Tags::ClassificationStore->value]
    )]
    #[IdParameter(type: 'group configuration')]
    #[ReferenceRequestBody(GroupUpdate::class)]
    #[SuccessResponse(
        description: 'classification_store_configuration_group_update_success_response',
    ...
    public function updateGroup(
        int $id,
        #[MapRequestPayload] GroupUpdate $parameters
    ): JsonResponse {
        return $this->jsonResponse($this->groupService->updateGroup($id, $parameters));
    }
}
