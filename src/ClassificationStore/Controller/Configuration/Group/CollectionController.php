...
final class CollectionController extends AbstractApiController
{
    ...
    private const string ROUTE = '/classification-store/configuration/stores/{storeId}/groups';
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_cs_configuration_group_collection', methods: ['POST'])]
    #[IsGranted(UserPermissions::CLASSIFICATION_STORE->value)]
    #[Post(
        path: self::PREFIX . self::ROUTE,
        operationId: 'classification_store_configuration_group_collection',
        description: 'classification_store_configuration_group_collection_description',
        summary: 'classification_store_configuration_group_collection_summary',
        tags: [Tags::ClassificationStore->value]
    )]
    #[IntParameter(name: 'storeId', example: 1, description: 'ID of the store to list groups for')]
    #[CollectionRequestBody(
        columnFiltersExample: '[{"type":"search","filterValue":"my-group"}]',
        sortFilterExample: '{"key":"name","direction":"ASC"}'
    )]
    #[SuccessResponse(
        description: 'classification_store_configuration_group_collection_success_response',
        content: new CollectionJson(new GenericCollection(GroupDetail::class))
    )]
    #[DefaultResponses([
    ...
    public function getGroups(
        ...
        $collection = $this->groupService->listGroups($parameters, $storeId);
