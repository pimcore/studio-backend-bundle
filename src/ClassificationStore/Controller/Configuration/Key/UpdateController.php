...
{
    private const string ROUTE = '/classification-store/configuration/keys/{id}';
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_cs_configuration_key_update', methods: ['PUT'])]
    #[IsGranted(UserPermissions::CLASSIFICATION_STORE->value)]
    #[Put(
        path: self::PREFIX . self::ROUTE,
        operationId: 'classification_store_configuration_key_update',
        description: 'classification_store_configuration_key_update_description',
        summary: 'classification_store_configuration_key_update_summary',
        tags: [Tags::ClassificationStore->value]
    )]
    #[IdParameter(type: 'key configuration')]
    #[ReferenceRequestBody(KeyUpdate::class)]
    #[SuccessResponse(
        description: 'classification_store_configuration_key_update_success_response',
        content: new JsonContent(ref: KeyDetail::class)
    )]
    #[DefaultResponses([
    ...
    public function updateKey(
        int $id,
        #[MapRequestPayload] KeyUpdate $parameters
    ): JsonResponse {
        return $this->jsonResponse($this->keyService->updateKey($id, $parameters));
    }
}
