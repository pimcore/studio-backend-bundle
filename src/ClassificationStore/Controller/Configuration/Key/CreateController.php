...
{
    private const string ROUTE = '/classification-store/configuration/keys/add';
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_cs_configuration_key_create', methods: ['POST'], priority: 10)]
    ...
    #[ReferenceRequestBody(KeyCreate::class)]
    #[SuccessResponse(
        description: 'classification_store_configuration_key_create_success_response',
    ...
    public function createKey(
        #[MapRequestPayload] KeyCreate $parameters
    ): JsonResponse {
        return $this->jsonResponse($this->keyService->createKey($parameters));
    }
}
