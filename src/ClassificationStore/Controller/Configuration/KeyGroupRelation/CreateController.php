...
{
    private const string ROUTE = '/classification-store/configuration/key-group-relations/add';
    ...
    #[Route(
        self::ROUTE,
        name: 'pimcore_studio_api_cs_configuration_key_group_relation_create',
        methods: ['POST'],
        priority: 10
    )]
    ...
    #[Post(
        ...
        description: 'classification_store_configuration_key_group_relation_create_description',
        summary: 'classification_store_configuration_key_group_relation_create_summary',
        tags: [Tags::ClassificationStore->value]
    )]
    #[ReferenceRequestBody(KeyGroupRelationCreate::class)]
    #[SuccessResponse(
        description: 'classification_store_configuration_key_group_relation_create_success_response',
        content: new JsonContent(ref: KeyGroupRelationDetail::class)
    )]
    #[DefaultResponses([
        HttpResponseCodes::UNAUTHORIZED,
        HttpResponseCodes::INTERNAL_SERVER_ERROR,
    ])]
    public function createKeyGroupRelation(
        #[MapRequestPayload] KeyGroupRelationCreate $parameters
    ): JsonResponse {
        return $this->jsonResponse(
            $this->keyGroupRelationService->createOrUpdateKeyGroupRelation($parameters)
        );
    }
}
