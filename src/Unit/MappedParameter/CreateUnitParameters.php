 ...
 */
#[Schema(
    schema: 'CreateUnitParameters',
    title: 'Create Unit Parameters',
    required: ['id'],
    type: 'object'
)]
final readonly class CreateUnitParameters implements UnitParametersInterface
{
    public function __construct(
        #[Property(description: 'Unique unit ID', type: 'string', example: 'mm')]
        private string $id,
