 ...
 * @internal
 */
final class OAuthScopeProviderPass implements CompilerPassInterface
{
    ...
    {
        foreach (array_keys($container->findTaggedServiceIds(ScopeProviderInterface::TAG)) as $serviceId) {
            $this->checkInterface($serviceId, ScopeProviderInterface::class);
        }
    }
}
