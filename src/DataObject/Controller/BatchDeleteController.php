...
{
    private const string ROUTE = '/data-objects/batch-delete';
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_data_objects_batch_delete', methods: ['DELETE'])]
    #[IsGranted(UserPermissions::DATA_OBJECTS->value)]
    #[Delete(
        path: self::PREFIX . self::ROUTE,
        operationId: 'data_object_batch_delete',
        description: 'data_object_batch_delete_description',
        summary: 'data_object_batch_delete_summary',
    ...
    #[CreatedResponse(
        description: 'data_object_batch_delete_created_response',
    ...
    public function dataObjectBatchDelete(#[MapRequestPayload] IdsParameter $parameter): Response
    {
