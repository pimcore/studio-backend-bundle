...
final readonly class SliderAdapter implements SetterDataInterface
{
    use DefaultSetterValueTrait;

    public function getDataForSetter(Concrete $element, Data $fieldDefinition, string $key, array $data): ?float
    {
