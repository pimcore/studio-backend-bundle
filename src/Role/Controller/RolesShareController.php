 ...
 * @internal
 */
final class RolesShareController extends AbstractApiController
{
    use PaginatedResponseTrait;

    private const string ROUTE = '/roles-share-list';
    ...
    #[Route(self::ROUTE, name: 'pimcore_studio_api_roles_share_list', methods: ['GET'])]
    #[IsGranted(UserPermissions::SHARE_CONFIGURATIONS->value)]
    #[Get(
        path: self::PREFIX . self::ROUTE,
        operationId: 'role_get_share_collection',
        description: 'role_get_share_collection_description',
        summary: 'role_get_share_collection_summary',
        tags: [Tags::Role->value]
    )]
    #[SuccessResponse(
        description: 'role_get_share_collection_success_response',
        content: new CollectionJson(new GenericCollection(SimpleRole::class))
    )]
    #[DefaultResponses]
    public function getRolesShareList(): JsonResponse
    {
