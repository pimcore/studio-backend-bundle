...
final class ImageVersionEvent extends AbstractPreResponseEvent
{
    public const EVENT_NAME = 'pre_response.image_version';
     ...
     */
    public function getVersion(): ImageVersion
    {
        return $this->version;
    }
}
