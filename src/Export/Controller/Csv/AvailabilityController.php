...
final class AvailabilityController extends AbstractApiController
{
     ...
     */
    #[Route(
        '/export/download/csv/{jobRunId}/available',
        name: 'pimcore_studio_api_export_download_csv_available',
        methods: ['GET']
    )]
    #[Get(
        path: self::PREFIX . '/export/download/csv/{jobRunId}/available',
        operationId: 'export_download_csv_available',
        description: 'export_download_csv_available_description',
        summary: 'export_download_csv_available_summary',
        tags: [Tags::Export->value]
    )]
    #[IdParameter(type: 'JobRun', name: 'jobRunId')]
    #[SuccessResponse(
        description: 'export_download_csv_available_success_response',
    ...
    public function availableCsv(int $jobRunId): JsonResponse
    {
