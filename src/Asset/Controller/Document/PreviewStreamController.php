...
final class PreviewStreamController extends AbstractApiController
{
     ...
     */
    #[Route(
        '/assets/{id}/document/stream/preview',
        name: 'pimcore_studio_api_document_preview',
        methods: ['GET']
    )]
    #[IsGranted(UserPermissions::ASSETS->value)]
    #[Get(
        path: self::API_PATH . '/assets/{id}/document/stream/preview',
        operationId: 'streamDocumentPreview',
        description: 'Get document preview stream by id by path parameter',
        summary: 'Get document preview stream by id',
        tags: [Tags::Assets->name]
    )]
    #[IdParameter(type: 'document')]
    #[SuccessResponse(
        description: 'Document preview stream',
    ...
    public function streamVideoByThumbnail(int $id): StreamedResponse
    {
