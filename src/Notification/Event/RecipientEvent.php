...
final class RecipientEvent extends AbstractPreResponseEvent
{
    public const EVENT_NAME = 'pre_response.notification_recipient';

    public function __construct(
        private readonly Recipient $recipient
    ) {
        parent::__construct($this->recipient);
    }
