...
{
    private const string ROUTE = '/documents/translations/{id}/add/{translationId}';
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_documents_translation_add', methods: ['POST'])]
    #[IsGranted(UserPermissions::DOCUMENTS->value)]
    #[Post(
        path: self::PREFIX . self::ROUTE,
        operationId: 'document_add_translation',
        description: 'document_add_translation_description',
        summary: 'document_add_translation_summary',
        tags: [Tags::Documents->value]
    )]
    #[SuccessResponse(description: 'document_add_translation_success_response')]
    ...
    public function addDocumentTranslation(int $id, int $translationId): Response
    {
        $this->translationService->addDocumentTranslation($id, $translationId);
