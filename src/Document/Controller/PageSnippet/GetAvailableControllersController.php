...
final class GetAvailableControllersController extends AbstractApiController
{
    ...
    #[Route(
        path: self::ROUTE,
        name: 'pimcore_studio_api_list_document_available_controllers',
        methods: ['GET']
    )]
    #[Get(
        path: self::PREFIX . self::ROUTE,
        operationId: 'document_available_controllers_list',
        description: 'document_available_controllers_list_description',
        summary: 'document_available_controllers_list_summary',
        tags: [Tags::Documents->value]
    )]
    #[SuccessResponse(
        description: 'document_available_controllers_list_success_response',
        content: new ItemsJson(Controller::class),
    )]
    #[DefaultResponses([
    ...
    public function getAvailableControllers(): JsonResponse
    {
        return $this->jsonResponse(['items' => $this->pageSnippetService->getAvailableControllers()]);
    }
}
