...
final class SiteDetailEvent extends AbstractPreResponseEvent
{
    public const string EVENT_NAME = 'pre_response.document.site.detail';

    public function __construct(
        private readonly SiteDetail $site
    ) {
     ...
     */
    public function getSite(): SiteDetail
    {
        return $this->site;
    }
}
