...
final class TemplateEvent extends AbstractPreResponseEvent
{
    public const string EVENT_NAME = 'pre_response.document.list_available_templates';
     ...
     */
    public function getController(): Template
    {
