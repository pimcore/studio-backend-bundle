...
use Pimcore\Bundle\GenericDataIndexBundle\Permission\DocumentPermissions as SearchDocumentPermissions;
use Pimcore\Bundle\StudioBackendBundle\Document\Schema\DocumentPermissions;

/**
 * @internal
 */
final readonly class PermissionsHydrator implements PermissionsHydratorInterface
{
    public function hydrate(SearchDocumentPermissions $permissions): DocumentPermissions
    {
