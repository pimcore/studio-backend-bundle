        ...
        foreach (
            ...
            if (isset($value['is']) && $setting == 'is') {
                $query->classificationStoreFilter(
                    ...
                    $group->getName(),
                    new NumberFilter($key->getName(), $value['is'], true),
                    null
                );
            }
            ...
            if (isset($filterValue['to']) && $setting == 'less') {
                $query->classificationStoreFilter(
                    $column->getKeyWithOutLocale(),
                    $group->getName(),
                    new NumberRangeFilter($column->getKey(), null, $filterValue['to'], true),
                    null
                );
            }
            ...
            if (isset($filterValue['from']) && $setting == 'more') {
                $query->classificationStoreFilter(
                    $column->getKeyWithOutLocale(),
                    $group->getName(),
                    new NumberRangeFilter($column->getKey(), $filterValue['from'], null, true),
                    null
                );
            }
            ...
            if ($setting == 'between') {
                $query->classificationStoreFilter(
                    $column->getKeyWithOutLocale(),
                    $group->getName(),
                    new NumberRangeFilter($column->getKey(), $filterValue['from'], $filterValue['to'], true),
                    null
                );
            }
        }
