...
{
    public const string EVENT_NAME = 'pre_response.thumbnail.video_config_detail';

    public function __construct(
        private readonly VideoThumbnailConfigDetail $thumbnailConfigDetail
    ) {
        parent::__construct($thumbnailConfigDetail);
    }

    public function getThumbnailConfigDetail(): VideoThumbnailConfigDetail
    {
