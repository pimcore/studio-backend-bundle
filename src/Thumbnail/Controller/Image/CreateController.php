...
{
    private const string ROUTE = '/thumbnails/image/config';
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_thumbnails_image_create', methods: ['POST'])]
    #[IsGranted(UserPermissions::THUMBNAILS->value)]
    #[Post(
        path: self::PREFIX . self::ROUTE,
        operationId: 'thumbnail_image_create',
        description: 'thumbnail_image_create_description',
        summary: 'thumbnail_image_create_summary',
        tags: [Tags::AssetThumbnails->value]
    )]
    #[ReferenceRequestBody(CreateThumbnailConfig::class)]
    #[SuccessResponse(
        description: 'thumbnail_image_create_success_response',
    ...
    public function createThumbnail(#[MapRequestPayload] CreateThumbnailConfig $parameters): JsonResponse
    {
        return $this->jsonResponse(
            $this->imageThumbnailService->addThumbnail($parameters->getName())
        );
    }
}
