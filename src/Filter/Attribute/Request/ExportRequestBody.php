...
use Pimcore\Bundle\StudioBackendBundle\Filter\Attribute\Property\ExportFilterProperty;

/**
 * @internal
 */
#[Attribute(Attribute::TARGET_METHOD)]
final class ExportRequestBody extends RequestBody
{
