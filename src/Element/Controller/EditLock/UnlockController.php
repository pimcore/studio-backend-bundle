 ...
 * @internal
 */
final class UnlockController extends AbstractApiController
{
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_elements_unlock', methods: ['DELETE'])]
    #[IsGranted(UserPermissions::ELEMENT_TYPE_PERMISSION->value)]
    #[Delete(
        path: self::PREFIX . self::ROUTE,
        operationId: 'element_unlock',
        description: 'element_unlock_description',
        summary: 'element_unlock_summary',
        tags: [Tags::Elements->name]
    )]
    #[IdParameter]
    #[ElementTypeParameter]
    #[SuccessResponse(
        description: 'element_unlock_success_response'
    )]
    #[DefaultResponses([
        HttpResponseCodes::INTERNAL_SERVER_ERROR,
        HttpResponseCodes::UNAUTHORIZED,
    ])]
    public function unlockElement(int $id, string $elementType): Response
    {
        $this->editLockService->unlockElement($id, $elementType);
