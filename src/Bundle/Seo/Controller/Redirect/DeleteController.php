...
final class DeleteController extends AbstractApiController
{
     ...
     */
    #[Route(self::ROUTE, name: 'pimcore_studio_api_bundle_seo_redirects_delete', methods: ['DELETE'])]
    ...
    #[Delete(
        ...
        summary: 'bundle_seo_redirect_delete_summary',
        tags: [Tags::BundleSeo->value]
    )]
    #[IdParameter(type: 'redirect')]
    #[SuccessResponse(
        description: 'bundle_seo_redirect_delete_success_response',
    )]
    #[DefaultResponses([
    ...
    {
        $this->redirectsService->deleteRedirect($id);
