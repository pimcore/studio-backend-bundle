...
use Pimcore\Bundle\StudioBackendBundle\Bundle\CustomReport\Attribute\Request\DrillDownRequestBody;
...
{
    private const string ROUTE = '/bundle/custom-reports/drill-down-options';
