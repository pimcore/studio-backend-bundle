...
Perspectives define custom views in Pimcore Studio. Customize the default perspective or create new ones.
Each perspective arranges widgets on the left, right, and bottom panels.
